<?php
function tc_visitors_tracker_get_browser_file($browsername) {
...
function tc_visitors_tracker_get_os_file($osname) {
...
function tc_visitors_tracker_timestamp_datetime($timestamp, $format = 'Y-m-d H:i:s', $timezone) {
  $date = new DateTime();
  $date->setTimezone(new DateTimeZone('UTC'));
  $date->setTimestamp($timestamp);
  $dt = $date->format('Y-m-d H:i:s');
  $date2 = new DateTime($dt, new DateTimeZone('UTC'));
